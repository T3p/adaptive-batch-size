...
class ActorNetwork(object):
    ...
    def get_flat_weights(self): 
        return flatten_params(self.sess.run(self.network_params))
...
def train(sess, env, actor, critic):
    ...
    for i in xrange(MAX_EPISODES):
        ...
        #Save weights 
        np.save(W_FILENAME.format('_it{}'.format(i)),actor.get_flat_weights())
        np.save(W_FILENAME.format(''),actor.get_flat_weights())
