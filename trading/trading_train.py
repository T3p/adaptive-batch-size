...
from mlppolicy_edit import NormalPolicy
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        m = len(theta)
        pol.reset(np.random.randn(m)*1e-2)
        #pol.update_outer_layer(np.ones(11)/11)
        ...
        while True: 
            ...
            theta = pol.get_weights()
            if record:
                fp.write("{} {} {} {} {} {}\n".format(iteration,infgrad,J_est,deltaJ_est,nav,theta))         
